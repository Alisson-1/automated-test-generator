...
export function CreateExamModal({ allQuestions, onSave, onClose }: CreateExamModalProps) {
  const {
    title,
    setTitle,
    questionIds,
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          ...
          {allQuestions.length === 0 ? (
            <p className="text-xs text-slate-400">No questions available. Create questions first.</p>
          ) : (
